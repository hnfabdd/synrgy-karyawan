...
public class LoginController {
    ...
    @Value("${BASEURL:}")//FILE_SHOW_URL
    private String BASEURL;

    @Value("${AUTHURL:}")//FILE_SHOW_URL
    private String AUTHURL;

    @Autowired
    public RegisterController registerController;

    @Value("${APPNAME:}")//FILE_SHOW_URL
...
//        Map<String, String> map = parameters.toSingleValueMap();
        ...
        Oauth2 oauth2 = new Oauth2.Builder(new NetHttpTransport(), new JacksonFactory(), credential).setApplicationName(
                "Oauth2").build();
        // step 3 : oauth2 akan diolah oleh Userinfoplus : google (DTO)
        ...
        // step 4 : kita hanya email, full name  dari DTO Userinfoplus dan kita check ke db untuk validasi
